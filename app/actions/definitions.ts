...
export async function deleteProject(id: number) {
	try {
		...
		return {
			success: false,
			error: 'Proje silinirken bir hata oluştu. İlişkili kayıtlar olabilir.',
		};
	}
}
...
export async function deleteUnit(id: number) {
	try {
		...
		return {
			success: false,
			error: 'Birim silinirken bir hata oluştu. İlişkili kayıtlar olabilir.',
		};
	}
}
...
export async function deletePerson(id: number) {
	try {
		...
		return {
			success: false,
			error: 'Kişi silinirken bir hata oluştu. İlişkili kayıtlar olabilir.',
		};
	}
}
